...
class Input extends Component {
  ...
  validateOptions() {
    ...
    if (this.options.hasOwnProperty("vanilla") && typeof vanilla != "boolean")
      throw new Error("Vanilla must be a boolean value");
    if (
  ...
  sanitize() {
    ...
    if (!(this.input instanceof HTMLElement))
      throw new Error("Can't find input ref!");
    try {
